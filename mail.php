...
$site_top = "http://www.airproducts.jp/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください)
/* $to = "kanri@airproducts.jp"; */
$to = "kanri@airproducts.jp";
...
$thanksPage = "http://www.airproducts.jp/formmail/thanks.html";
...
$eles = array('名前','フリガナ','社名','郵便番号','ご住所','電話番号','Email');
